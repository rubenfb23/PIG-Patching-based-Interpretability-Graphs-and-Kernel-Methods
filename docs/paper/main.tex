...
\textbf{Hashed fixed-layout.} We map each edge slot to a fixed coordinate $j = h(u, v) \bmod d$ using a stable hash function, following the feature-hashing principle \cite{weinberger2009feature}, and accumulate the signed weight:
\begin{equation}
